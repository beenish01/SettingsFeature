...
// import { Settings, ALargeSmall, Eye, ArrowLeftRight, User, Globe, Mail } from "lucide-react";
...
//   useEffect(() => {
//     // Apply any saved settings on initial load
...
//         break;
//       case 'comic':
//         fontFamilyValue = "'Comic Sans MS', sans-serif";
//         break;
//       case 'arial':
...
//                   </div>
//                   <p className="text-sm text-gray-500">Receive email notifications from us</p>
//                 </div>
//                 <Switch
...
//                 </div>
//                 <p className="text-sm text-gray-500">Choose a font that works best for you</p>
//               </div>
...
//                 </div>
//                 <p className="text-sm text-gray-500">Adjust spacing between letters for better readability</p>
//               </div>
...
//                 </div>
//                 <p className="text-sm text-gray-500">Enhance visual contrast for better visibility</p>
//               </div>
//               <Switch 
